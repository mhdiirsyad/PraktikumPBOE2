 ...
 * @author Irsyad
 */
public class GUISaveList extends javax.swing.JFrame {
    
    DefaultListModel<String> dlm;
    List<String> items = new ArrayList<>();
    String[] datas = {"buku", "meja", "kursi", "pintu", "meja"};
    /**
     * Creates new form GUISaveList
     */
    public GUISaveList() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabelDataTersimpan.setFont(new java.awt.Font("Segoe UI", 1, 10)); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GUISaveList.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GUISaveList().setVisible(true);
            }
        });
    }
